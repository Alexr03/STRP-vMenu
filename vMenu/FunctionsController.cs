...
namespace vMenuClient
{
    ...
    class FunctionsController : BaseScript
    {
        ...
        public void SetupTickFunctions()
        {
            ...
            if (IsAllowed(Permission.Staff) && GetSettingsBool(Setting.vmenu_menu_staff_only) || !GetSettingsBool(Setting.vmenu_menu_staff_only))
            {
                Tick += MiscSettings;
                Tick += GeneralTasks;
        ...
        private async Task PlayerOptions()
        {
            ...
            if (MainMenu.MpPedCustomizationMenu != null && MainMenu.MpPedCustomizationMenu.appearanceMenu != null &&
                MainMenu.MpPedCustomizationMenu.faceShapeMenu != null &&
                MainMenu.MpPedCustomizationMenu.createCharacterMenu != null &&
                MainMenu.MpPedCustomizationMenu.inheritanceMenu != null &&
                MainMenu.MpPedCustomizationMenu.propsMenu != null &&
                MainMenu.MpPedCustomizationMenu.clothesMenu != null &&
                MainMenu.MpPedCustomizationMenu.tattoosMenu != null)
            {
                ...
                {
                    SetEntityInvincible(Game.PlayerPed.Handle,
                        MainMenu.PlayerOptionsMenu.PlayerGodMode && godmodeAllowed);
                }
            }

            // Manage PlayerInvisible
            if (GetSettingsBool(Setting.vmenu_handle_invisibility) && MainMenu.PlayerOptionsMenu.PlayerInvisible &&
                IsAllowed(Permission.POInvisible))
            {
            ...
            // Manage never wanted.
            if (MainMenu.PlayerOptionsMenu.PlayerNeverWanted && GetPlayerWantedLevel(Game.Player.Handle) > 0 &&
                IsAllowed(Permission.PONeverWanted))
            {
        ...
        {
            bool god = IsAllowed(Permission.POGod) && MainMenu.PlayerOptionsMenu != null &&
                       MainMenu.PlayerOptionsMenu.PlayerGodMode;
            await Delay(100);

            bool vehGod = IsAllowed(Permission.VOGod) && MainMenu.VehicleOptionsMenu != null &&
                          MainMenu.VehicleOptionsMenu.VehicleGodMode;
            await Delay(100);

            bool ignored = IsAllowed(Permission.POIgnored) && MainMenu.PlayerOptionsMenu != null &&
                           MainMenu.PlayerOptionsMenu.PlayerIsIgnored;
            await Delay(100);

            bool stayInVeh = IsAllowed(Permission.POStayInVehicle) && MainMenu.PlayerOptionsMenu != null &&
                             MainMenu.PlayerOptionsMenu.PlayerStayInVehicle;
            await Delay(100);

            bool bikeSeatbelt = IsAllowed(Permission.VOBikeSeatbelt) && MainMenu.VehicleOptionsMenu != null &&
                                MainMenu.VehicleOptionsMenu.VehicleBikeSeatbelt;
            await Delay(100);

            bool noRagdoll = IsAllowed(Permission.PONoRagdoll) && MainMenu.PlayerOptionsMenu != null &&
                             MainMenu.PlayerOptionsMenu.PlayerNoRagdoll;
            await Delay(100);
        ...
        private async Task VehicleOptions()
        {
            ...
            if (IsPedInAnyVehicle(Game.PlayerPed.Handle, true))
            {
                ...
                if (veh != null && veh.Exists())
                {
                    ...
                    if (MainMenu.VehicleOptionsMenu.VehicleNeverDirty && veh.DirtLevel > 0f &&
                        IsAllowed(Permission.VOKeepClean))
                    {
                        veh.Wash();
                    }
                    ...
                    if (MainMenu.VehicleOptionsMenu.VehicleTorqueMultiplier && IsAllowed(Permission.VOTorqueMultiplier))
                    {
                        ...
                        SetVehicleEngineTorqueMultiplier(veh.Handle,
                            MainMenu.VehicleOptionsMenu.VehicleTorqueMultiplierAmount);
                    }
                    ...
                    if (SwitchedVehicle)
                    {
                        ...
                        if (IsAllowed(Permission.VOChangePlate) &&
                            MainMenu.VehicleOptionsMenu.GetMenu().GetMenuItems().Find(mi =>
                                    mi is MenuListItem li &&
                                    li.ListItems.Any(liText => liText == GetLabelText("CMOD_PLA_0"))) is MenuListItem
                                listItem)
                        {
                        ...
                        if (MainMenu.VehicleOptionsMenu.VehiclePowerMultiplier &&
                            IsAllowed(Permission.VOPowerMultiplier))
                        {
                            SetVehicleEnginePowerMultiplier(veh.Handle,
                                MainMenu.VehicleOptionsMenu.VehiclePowerMultiplierAmount);
                        }
                        ...
                        {
                            // No Siren Toggle
                            veh.IsSirenSilent = MainMenu.VehicleOptionsMenu.VehicleNoSiren &&
                                                IsAllowed(Permission.VONoSiren);
                        }
                        ...
                        if (veh.Model.IsPlane)
                        {
                            if (MainMenu.VehicleOptionsMenu.DisablePlaneTurbulence &&
                                IsAllowed(Permission.VODisableTurbulence))
                            {
                    ...
                    if (ped.IsWearingHelmet && MainMenu.VehicleOptionsMenu.VehicleNoBikeHelemet &&
                        IsAllowed(Permission.VONoHelmet))
                    {
                        ped.RemoveHelmet(true);
                    }

                    if (MainMenu.VehicleOptionsMenu.VehicleInfiniteFuel && DecorIsRegisteredAsType("_Fuel_Level", 1) &&
                        IsAllowed(Permission.VOInfiniteFuel))
                    {
            ...
            if (MainMenu.VehicleOptionsMenu.VehicleEngineAlwaysOn && GetVehicle(true) != null &&
                GetVehicle(true).Exists() && !Game.PlayerPed.IsInVehicle() && IsAllowed(Permission.VOEngineAlwaysOn))
            {
                await Delay(100);
        ...
        private async void DrawMiscSettingsText()
        {
            ...
            if (MainMenu.MiscSettingsMenu.ShowCoordinates && IsAllowed(Permission.MSShowCoordinates))
            {
                ...
                double x = Math.Round(pos.X, 2),
                    ...
                    heading = Math.Round(Game.PlayerPed.Heading, 2);
                SetScriptGfxAlign(0, 84);
                SetScriptGfxAlignParams(0f, 0f, 0f, 0f);
                DrawTextOnScreen($"~r~X~s~ \t\t{x}\n~r~Y~s~ \t\t{y}\n~r~Z~s~ \t\t{z}\n~r~Heading~s~ \t{heading}",
                    0.5f - (30f / Resolution.Width), 0f, 0.5f, Alignment.Left, 6, false);
                ResetScriptGfxAlign();
            }
            ...
            if (MainMenu.MiscSettingsMenu.DrawTimeOnScreen)
            {
                ...
                SetScriptGfxAlign(0, 84);
                SetScriptGfxAlignParams(0f, 0f, 0f, 0f);
                DrawTextOnScreen($"~c~{timestring}", 0.208f + safeZoneSizeX,
                    GetSafeZoneSize() - GetTextScaleHeight(0.4f, 1), 0.40f, Alignment.Center);
                ResetScriptGfxAlign();
            }
        ...
        private async Task UpdateLocation()
        {
            if (MainMenu.MiscSettingsMenu.ShowLocation)
            {
                ...
                suffix = (crossingName != "" && crossingName != "NULL" && crossingName != null)
                    ? "~t~ / " + crossingName
                    : "";
        ...
        private void ShowLocation()
        {
            ...
            SetTextWrap(0f, 1f);
            DrawTextOnScreen(prefix + World.GetStreetName(currentPos) + suffix, 0.234f + safeZoneSizeX,
                GetSafeZoneSize() - GetTextScaleHeight(0.48f, 6) -
                GetTextScaleHeight(0.48f, 6) /*0.925f - safeZoneSizeY*/, 0.48f);

            // Draw the zone name.
            SetTextWrap(0f, 1f);
            DrawTextOnScreen(World.GetZoneLocalizedName(currentPos), 0.234f + safeZoneSizeX,
                GetSafeZoneSize() - GetTextScaleHeight(0.45f, 6) -
                GetTextScaleHeight(0.95f, 6) /*0.9485f - safeZoneSizeY*/, 0.45f);

            // Draw the left border for the heading character.
            SetTextWrap(0f, 1f);
            DrawTextOnScreen("~t~|", 0.188f + safeZoneSizeX,
                GetSafeZoneSize() - GetTextScaleHeight(1.2f, 6) -
                GetTextScaleHeight(0.4f, 6) /*0.915f - safeZoneSizeY*/, 1.2f, Alignment.Left);

            // Draw the heading character.
            SetTextWrap(0f, 1f);
            DrawTextOnScreen(headingCharacter, 0.208f + safeZoneSizeX,
                GetSafeZoneSize() - GetTextScaleHeight(1.2f, 6) -
                GetTextScaleHeight(0.4f, 6) /*0.915f - safeZoneSizeY*/, 1.2f, Alignment.Center);

            // Draw the right border for the heading character.
            SetTextWrap(0f, 1f);
            DrawTextOnScreen("~t~|", 0.228f + safeZoneSizeX,
                GetSafeZoneSize() - GetTextScaleHeight(1.2f, 6) -
                GetTextScaleHeight(0.4f, 6) /*0.915f - safeZoneSizeY*/, 1.2f, Alignment.Right);
        }
        ...
        private async Task MiscSettings()
        {
                ...
                if (IsAllowed(Permission.MSDriftMode))
                {
                    if (Game.PlayerPed.IsInVehicle())
                    {
                        ...
                        if (veh != null && veh.Exists() && !veh.IsDead)
                        {
                            ...
                            else if ((Game.IsControlJustReleased(0, Control.Sprint) &&
                                      Game.CurrentInputMode == InputMode.MouseAndKeyboard) ||
                                     (Game.IsControlJustReleased(0, Control.Jump) &&
            ...
            else
            {
                ...
                if (Game.IsControlJustReleased(0, Control.MultiplayerInfo) &&
                    Game.IsControlEnabled(0, Control.MultiplayerInfo) && MainMenu.MiscSettingsMenu.KbRadarKeys &&
                    !MenuController.IsAnyMenuOpen() && !IsPauseMenuActive())
                {
        ...
        private void OnJoinQuitNotification(string playerName, string dropReason)
        {
            if (MainMenu.PermissionsSetupComplete && MainMenu.MiscSettingsMenu != null)
            {
                ...
                if (MainMenu.MiscSettingsMenu.JoinQuitNotifications && IsAllowed(Permission.MSJoinQuitNotifs))
                {
                    ...
                    {
                        Notify.Custom(
                            $"~r~<C>{GetSafePlayerName(playerName)}</C>~s~ left the server. ~c~({GetSafePlayerName(dropReason)})");
                    }
                }
            }
        }
                                ...
                                if (killer.Exists())
                                {
                                    if (killer.Model.IsPed)
                                    {
                                        ...
                                        foreach (Player playerKiller in pl)
                                        {
                                            ...
                                            {
                                                Notify.Custom(
                                                    $"~o~<C>{GetSafePlayerName(p.Name)}</C> ~s~has been murdered by ~y~<C>{GetSafePlayerName(playerKiller.Name)}</C>~s~.");
                                                found = true;
                                                break;
                                            }
                                        }
                                        ...
                                        {
                                            Notify.Custom(
                                                $"~o~<C>{GetSafePlayerName(p.Name)}</C> ~s~has been murdered.");
                                        }
                                    }
        ...
        private async Task VoiceChat()
        {
            if (MainMenu.VoiceChatSettingsMenu.EnableVoicechat && IsAllowed(Permission.VCEnable))
            {
                ...
                int channel =
                    MainMenu.VoiceChatSettingsMenu.channels.IndexOf(MainMenu.VoiceChatSettingsMenu.currentChannel);
                if (channel < 1)
                {
                ...
                if (MainMenu.VoiceChatSettingsMenu.ShowVoiceStatus)
                {
                    ...
                    {
                        DrawSprite("mpleaderboard", $"leaderboard_audio_{voiceCycle}", 0.008f, 0.985f,
                            voiceIndicatorWidth, voiceIndicatorHeight, 0f, 255, 55, 0, 255);
                    }
                    else
                    {
                        DrawSprite("mpleaderboard", "leaderboard_audio_mute", 0.008f, 0.985f, voiceIndicatorMutedWidth,
                            voiceIndicatorHeight, 0f, 255, 55, 0, 255);
                    }
                }
                else
                {
        ...
        private async Task TimeOptions()
        {
            if ((MainMenu.TimeOptionsMenu.freezeTimeToggle != null && MainMenu.TimeOptionsMenu.GetMenu().Visible) &&
                IsAllowed(Permission.TOFreezeTime))
            {
        ...
        private async Task WeaponOptions()
        {
            ...
            if (Game.PlayerPed.Weapons.Current != null && Game.PlayerPed.Weapons.Current.Hash != WeaponHash.Unarmed)
            {
                Game.PlayerPed.Weapons.Current.InfiniteAmmo = MainMenu.WeaponOptionsMenu.UnlimitedAmmo &&
                                                              IsAllowed(Permission.WPUnlimitedAmmo);
            }

            if (MainMenu.WeaponOptionsMenu.AutoEquipChute)
            {
                if ((IsPedInAnyHeli(Game.PlayerPed.Handle) || IsPedInAnyPlane(Game.PlayerPed.Handle)) &&
                    !HasPedGotWeapon(Game.PlayerPed.Handle, (uint)WeaponHash.Parachute, false))
                {
        ...
        {
            if (MainMenu.PermissionsSetupComplete && MainMenu.OnlinePlayersMenu != null &&
                IsAllowed(Permission.OPMenu) && IsAllowed(Permission.OPSpectate))
            {
        ...
        private async Task ManageCamera()
        {
            if (Game.PlayerPed.IsInVehicle())
            {
                if (MainMenu.MpPedCustomizationMenu.editPedBtn != null &&
                    MainMenu.MpPedCustomizationMenu.editPedBtn.Enabled)
                {
                    ...
                    MainMenu.MpPedCustomizationMenu.editPedBtn.Description +=
                        " ~r~You need to get out of your vehicle before you can use this.";
                }

                if (MainMenu.MpPedCustomizationMenu.createMaleBtn != null &&
                    MainMenu.MpPedCustomizationMenu.createMaleBtn.Enabled)
                {
                    ...
                    MainMenu.MpPedCustomizationMenu.createMaleBtn.Description +=
                        " ~r~You need to get out of your vehicle before you can use this.";
                }

                if (MainMenu.MpPedCustomizationMenu.createFemaleBtn != null &&
                    MainMenu.MpPedCustomizationMenu.createFemaleBtn.Enabled)
                {
                    ...
                    MainMenu.MpPedCustomizationMenu.createFemaleBtn.Description +=
                        " ~r~You need to get out of your vehicle before you can use this.";
                }
            }
            else
            {
                    ...
                    !MainMenu.MpPedCustomizationMenu.editPedBtn.Enabled)
                {
                    ...
                    MainMenu.MpPedCustomizationMenu.editPedBtn.Description =
                        MainMenu.MpPedCustomizationMenu.editPedBtn.Description.Replace(
                            " ~r~You need to get out of your vehicle before you can use this.", "");
                }
                    ...
                    !MainMenu.MpPedCustomizationMenu.createMaleBtn.Enabled)
                {
                    ...
                    MainMenu.MpPedCustomizationMenu.createMaleBtn.Description =
                        MainMenu.MpPedCustomizationMenu.createMaleBtn.Description.Replace(
                            " ~r~You need to get out of your vehicle before you can use this.", "");
                }
                    ...
                    !MainMenu.MpPedCustomizationMenu.createFemaleBtn.Enabled)
                {
                    ...
                    MainMenu.MpPedCustomizationMenu.createFemaleBtn.Description =
                        MainMenu.MpPedCustomizationMenu.createFemaleBtn.Description.Replace(
                            " ~r~You need to get out of your vehicle before you can use this.", "");
                }
            }
            ...
            if (IsMpCharEditorOpen())
            {
                ...
                while (IsMpCharEditorOpen())
                {
                    ...
                    if (MenuController.GetCurrentMenu() == MainMenu.MpPedCustomizationMenu.propsMenu &&
                        MenuController.GetCurrentMenu().CurrentIndex == 3 && !reverseCamera)
                    {
                        TaskPlayAnim(Game.PlayerPed.Handle, "anim@random@shop_clothes@watches", "BASE", 8f, -8f, -1, 1,
                            0, false, false, false);
                    }
                    else
                    {
                    ...
                    if ((Game.IsControlPressed(0, Control.ParachuteBrakeLeft) ||
                    ...
                    Vector3 pos;
                    if (reverseCamera)
                        pos = GetOffsetFromEntityInWorldCoords(Game.PlayerPed.Handle,
                            (CameraOffsets[index].Key.X + xOffset) * -1f, (CameraOffsets[index].Key.Y + yOffset) * -1f,
                            CameraOffsets[index].Key.Z);
                    else
                        pos = GetOffsetFromEntityInWorldCoords(Game.PlayerPed.Handle,
                            (CameraOffsets[index].Key.X + xOffset), (CameraOffsets[index].Key.Y + yOffset),
                            CameraOffsets[index].Key.Z);
                    Vector3 pointAt = GetOffsetFromEntityInWorldCoords(Game.PlayerPed.Handle,
                        CameraOffsets[index].Value.X, CameraOffsets[index].Value.Y, CameraOffsets[index].Value.Z);

                    if (Game.IsControlPressed(0, Control.MoveLeftOnly))
                    {
                        Game.PlayerPed.Task.LookAt(
                            GetOffsetFromEntityInWorldCoords(Game.PlayerPed.Handle, 1.2f, .5f, .7f), 1100);
                    }
                    ...
                    {
                        Game.PlayerPed.Task.LookAt(
                            GetOffsetFromEntityInWorldCoords(Game.PlayerPed.Handle, 0f, .5f, .7f), 1100);
                    }
                    ...
                    if (Game.IsControlJustReleased(0, Control.Jump))
                    {
                        ...
                        TaskGoStraightToCoord(Game.PlayerPed.Handle, Pos.X, Pos.Y, Pos.Z, 8f, 1600,
                            Game.PlayerPed.Heading + 180f, 0.1f);
                        int timer = GetGameTimer();
                        while (true)
                        {
                            await Delay(0);
        ...
        private async Task RestorePlayerAfterBeingDead()
        {
            if (MainMenu.MiscSettingsMenu != null && Game.PlayerPed.IsDead)
            {
                ...
                if (MainMenu.MiscSettingsMenu.MiscRespawnDefaultCharacter)
                {
                    ...
                    {
                        Notify.Error(
                            "You did not set a saved character to restore to. Do so in the ~g~MP Ped Customization~s~ > ~g~Saved Characters~s~ menu.");
                    }
                }
                ...
                if (MainMenu.MiscSettingsMenu.RestorePlayerWeapons && IsAllowed(Permission.MSRestoreWeapons) ||
                    (MainMenu.WeaponLoadoutsMenu != null &&
                ...
                if (restoreDefault)
                {
                    await MainMenu.MpPedCustomizationMenu.SpawnThisCharacter(
                        GetResourceKvpString("vmenu_default_character"), false);
                }
                else
                {
                    if (IsTempPedSaved() && MainMenu.MiscSettingsMenu.RestorePlayerAppearance &&
                        IsAllowed(Permission.MSRestoreAppearance))
                    {
                        LoadSavedPed("vMenu_tmp_saved_ped", false);
                    }
                }

                if (MainMenu.MiscSettingsMenu != null && MainMenu.MiscSettingsMenu.RestorePlayerWeapons &&
                    IsAllowed(Permission.MSRestoreWeapons) || (MainMenu.WeaponLoadoutsMenu != null &&
                                                               MainMenu.WeaponLoadoutsMenu
                            ...
                            else if (decorVal == 3) // flash.
                            {
                                ...
                                if (clothingAnimationReverse)
                                {
                                    if ((clothingOpacity >= 0f &&
                                         clothingOpacity <=
                                         0.5f)) // || (clothingOpacity >= 0.5f && clothingOpacity <= 0.75f))
                                    {
                                        result = 1f;
                                    }
                                }
                                ...
                                {
                                    if ((clothingOpacity >= 0.5f &&
                                         clothingOpacity <=
                                         1.0f)) //|| (clothingOpacity >= 0.75f && clothingOpacity <= 1.0f))
                                    {
                                        result = 1f;
                                    }
                                }
                        ...
                        if (p != null && NetworkIsPlayerActive(p.Handle) && p.Character != null && p.Character.Exists())
                        {
                            ...
                            if (enabled)
                            {
                                if (!p.IsLocal)
                                {
                                    ...
                                    if (p.Character.Position.DistanceToSquared2D(Game.PlayerPed.Position) < 500000 ||
                                        Game.IsPaused)
                                    {
                                        ...
                                        {
                                            int decorSprite = DecorGetInt(p.Character.Handle,
                                                "vmenu_player_blip_sprite_id");
                            ...
                            else // blips are not enabled.
                            {
                                if (!(p.Character.AttachedBlip == null || !p.Character.AttachedBlip.Exists()) &&
                                    MainMenu.OnlinePlayersMenu != null &&
                                    !MainMenu.OnlinePlayersMenu.PlayersWaypointList.Contains(p.Handle))
                                {
        ...
        private float playerNamesDistance = GetSettingsFloat(Setting.vmenu_player_names_distance) > 10f
            ? GetSettingsFloat(Setting.vmenu_player_names_distance)
            : 500f;
                    ...
                    foreach (Player p in Players)
                    {
                        if (p != Game.Player)
                        {
                            ...
                            if (gamerTags.ContainsKey(p))
                            {
                                ...
                                {
                                    gamerTags[p] = CreateMpGamerTag(p.Character.Handle, p.Name + $" [{p.ServerId}]",
                                        false, false, "", 0);
                                }
                            }
                            else if (closeEnough)
                            {
                                gamerTags.Add(p,
                                    CreateMpGamerTag(p.Character.Handle, p.Name + $" [{p.ServerId}]", false, false, "",
                                        0));
                            }
                    ...
                    else
                    {
                        ...
                        if (Vdist2(pos1.X, pos1.Y, pos1.Z, pos2.X, pos2.Y, pos2.Z) < 20f)
                        {
                            ...
                            if (DoesBlipExist(blip))
                            {
                                ...
                                waypointPlayerIdsToRemove.Add(playerId);
                                Notify.Custom(
                                    $"~g~You've reached ~s~<C>{GetPlayerName(playerId)}</C>'s~g~ location, disabling GPS route.");
                            }
                        }
                    }
        ...
        */
        ...
        {
            if (!(MenuController.IsAnyMenuOpen() || MainMenu.DontOpenMenus || !Fading.IsFadedIn || Game.IsPaused ||
                  IsPlayerSwitchInProgress() || Game.PlayerPed.IsDead))
            {
                // snowballs
                if (EventManager.IsSnowEnabled && IsAllowed(Permission.WPSnowball))
                {
                    ...
                    {
                        if (!(Game.PlayerPed.IsInVehicle() || Game.PlayerPed.IsDead || !Fading.IsFadedIn ||
                              IsPlayerSwitchInProgress() || Game.IsPaused
                              || GetInteriorFromEntity(Game.PlayerPed.Handle) != 0 || !Game.PlayerPed.IsOnFoot ||
                              Game.PlayerPed.IsInParachuteFreeFall ||
                              Game.PlayerPed.IsFalling || Game.PlayerPed.IsBeingStunned || Game.PlayerPed.IsWalking ||
                              Game.PlayerPed.IsRunning ||
                              Game.PlayerPed.IsSprinting || Game.PlayerPed.IsSwimming ||
                              Game.PlayerPed.IsSwimmingUnderWater ||
                              Game.PlayerPed.IsDiving && GetSelectedPedWeapon(Game.PlayerPed.Handle) == snowball_hash ||
                              GetSelectedPedWeapon(Game.PlayerPed.Handle) == GetHashKey("unarmed")))
                        {
                ...
                {
                    int timer = GetGameTimer();
                    while (!(MenuController.IsAnyMenuOpen() || MainMenu.DontOpenMenus || !Fading.IsFadedIn ||
                             Game.IsPaused || IsPlayerSwitchInProgress() || Game.PlayerPed.IsDead) &&
                           Game.IsControlPressed(0, Control.SwitchVisor))
                    {
                        await Delay(0);
                        Vehicle veh = GetVehicle();
                    ...
                    foreach (Vehicle v in vehicles)
                    {
                        ...
                        if (MainMenu.MiscSettingsMenu.ShowEntityNetOwners && v.IsOnScreen)
                        {
                            ...
                            if (netOwnerLocalId != 0)
                            {
                                ...
                                SetDrawOrigin(v.Position.X, v.Position.Y, v.Position.Z + 0.3f, 0);
                                DrawTextOnScreen($"Owner ID {playerServerId} ({playerName})", 0f, 0f, 0.3f,
                                    Alignment.Center, 0);
                                ClearDrawOrigin();
                            }
                        }
        ...
        private async Task SlowMiscTick()
        {
            ...
            if (MainMenu.PermissionsSetupComplete && MainMenu.MiscSettingsMenu != null)
            {
                ...
                {
                    stopPropsLoop = true;
                    props = World.GetAllProps()
                        .Where(e => e.IsOnScreen && e.Position.DistanceToSquared(pp) < entityRange).ToList();
                    stopPropsLoop = false;
                ...
                {
                    stopPedsLoop = true;
                    peds = World.GetAllPeds().Where(e => e.IsOnScreen && e.Position.DistanceToSquared(pp) < entityRange)
                        .ToList();
                    stopPedsLoop = false;
        ...
        private async Task PersonalVehicleOptions()
        {
            if (MainMenu.PermissionsSetupComplete && MainMenu.PersonalVehicleMenu != null &&
                MainMenu.PersonalVehicleMenu.CurrentPersonalVehicle != null)
            {
                if (!Game.PlayerPed.IsInVehicle(MainMenu.PersonalVehicleMenu.CurrentPersonalVehicle) &&
                    !Game.PlayerPed.IsGettingIntoAVehicle)
                {
                    if (Game.PlayerPed.Position.DistanceToSquared(MainMenu.PersonalVehicleMenu.CurrentPersonalVehicle
                        .Position) < 650.0f)
                    {
                        if (Game.IsControlJustReleased(0, Control.VehicleHorn))
                        {
                            ...
                            if (GetGameTimer() - time < 500)
                            {
                                ...
                                await Delay(100);
                                bool lockDoors = !GetVehicleDoorsLockedForPlayer(
                                    MainMenu.PersonalVehicleMenu.CurrentPersonalVehicle.Handle, Game.PlayerPed.Handle);
                        ...
                        if (!didShowPvHelpMessage)
                        {
                            ...
                            HelpMessage.Custom(
                                "When you are close to your personal vehicle, you can double tap ~INPUT_VEH_HORN~ to lock or unlock it.",
                                10000, true);
                        }
                    }
                    else
        ...
        private async Task SwitchHelmetOnce()
        {
            if (MainMenu.PermissionsSetupComplete)
            {
                ...
                int compHash =
                    GetHashNameForProp(Game.PlayerPed.Handle, 0, component, texture); // prop combination hash
                if (N_0xd40aac51e8e4c663((uint)compHash) > 0) // helmet has visor.
                {
                    ...
                    if (Game.PlayerPed.IsInVehicle())
                    {
                        ...
                        Vehicle veh = GetVehicle();
                        if (veh != null && veh.Exists() && !veh.IsDead &&
                            (veh.Model.IsBicycle || veh.Model.IsBike || veh.Model.IsQuadbike))
                        {
                    ...
                    ClearPedTasks(Game.PlayerPed.Handle);
                    TaskPlayAnim(Game.PlayerPed.Handle, animDict, animName, 8.0f, 1.0f, -1, 48, 0.0f, false, false,
                        false);
                    ...
                    while (GetEntityAnimCurrentTime(Game.PlayerPed.Handle, animDict, animName) <= 0.0f)
                    {
                        if (GetGameTimer() - timeoutTimer > 1000)
                        {
                            ClearPedTasks(Game.PlayerPed.Handle);
                            Debug.WriteLine(
                                "[vMenu] [WARNING] Waiting for animation to start took too long. Preventing hanging of function. Dbg: fault in location 1.");
                            return;
                        }
                    ...
                    while (GetEntityAnimCurrentTime(Game.PlayerPed.Handle, animDict, animName) > 0.0f)
                    {
                        ...
                        if (GetGameTimer() - timeoutTimer > 3000)
                        {
                            ClearPedTasks(Game.PlayerPed.Handle);
                            Debug.WriteLine(
                                "[vMenu] [WARNING] Waiting for animation duration took too long. Preventing hanging of function. Dbg: fault in location 2.");
                            return;
                        }
        ...
        private async Task PickupSnowballOnce()
        {
            if (MainMenu.PermissionsSetupComplete)
            {
                ...
                if (GetAmmoInPedWeapon(Game.PlayerPed.Handle, snowball_hash) < maxAmmo)
                {
                    ...
                    TaskPlayAnim(Game.PlayerPed.Handle, snowball_anim_dict, snowball_anim_name, 8f, 1f, -1, 0, 0f,
                        false, false, false);
                    bool fired = false;

                    var dur = GetAnimDuration(snowball_anim_dict, snowball_anim_name);
                    int timer = GetGameTimer();
                    while (GetEntityAnimCurrentTime(Game.PlayerPed.Handle, snowball_anim_dict, snowball_anim_name) <
                           0.97f)
                    {
                        await Delay(0);
                        if (!fired)
